...
# essential
sudo apt-get install git cmake cmake-curses-gui build-essential gitg git-gui meld vim terminator mercurial libmatio-dev doxygen kazam kdevelop
...
if [ "`lsb_release -cs`" = 'xenial' ]; then
	...
	sudo apt-get install ros-kinetic-eigen-conversions ros-kinetic-kdl-parser ros-kinetic-effort-controllers ros-kinetic-transmission-interface
        ...
        sudo apt-get install ros-kinetic-joint-state* ros-joint-state-controller
...
if [ "`lsb_release -cs`" = 'bionic' ]; then
	...
	sudo apt-get install ros-melodic-joint-state* ros-joint-state-controller
...
if [ "`lsb_release -cs`" = 'focal' ]; then
	...
	sudo apt-get install ros-noetic-joint-state* ros-joint-state-controller
